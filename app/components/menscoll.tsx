  ...
  return (
    <div>
      <div className="hero bg-gradient-to-r from-blue-600 to-green-500 text-white p-12 text-center mb-8">
        <h1 className="text-4xl font-bold sm:text-5xl md:text-6xl">Exclusive Mens Fashion</h1>
        <p className="mt-4 text-lg sm:text-xl">Explore our curated collection of mens fashion and find the perfect style for every occasion.</p>
        <Link href="#products">
